function menu_load(x, y)
	...
	if soundenabled then
		pausebuttons["menutogglesound"] = pausebutton:new(109, screenheight-23, "Sound ON", menu_togglesound)
	else
		pausebuttons["menutogglesound"] = pausebutton:new(109, screenheight-23, "Sound OFF", menu_togglesound)
	end
